...
public class MenuNeutronCollector extends MenuMachine<TileNeutronCollector> {
	...
	public MenuNeutronCollector(int id, Inventory inventory, FriendlyByteBuf friendlyByteBuf) {
		this(id, inventory,
				(TileNeutronCollector) inventory.player.level().getBlockEntity(friendlyByteBuf.readBlockPos()),
				new SimpleContainerData(1));
	}

	public MenuNeutronCollector(int id, Inventory inventory, TileNeutronCollector machineTile,
