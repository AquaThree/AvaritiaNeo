...
public class MenuNeutroniumCompressor extends MenuMachine<TileNeutroniumCompressor> {
	...
	public MenuNeutroniumCompressor(int id, Inventory inventory, FriendlyByteBuf friendlyByteBuf) {
		this(id, inventory,
				(TileNeutroniumCompressor) inventory.player.level().getBlockEntity(friendlyByteBuf.readBlockPos()),
				new SimpleContainerData(6));
	}

	public MenuNeutroniumCompressor(int id, Inventory inventory, TileNeutroniumCompressor machineTile,
	...
	public ItemStack getMatrixItem() {
		Item item = BuiltInRegistries.ITEM.byId(this.dataAccess.get(5));
		if (item != null) {
