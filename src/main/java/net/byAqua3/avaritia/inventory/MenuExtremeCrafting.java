...
public class MenuExtremeCrafting extends AbstractContainerMenu {
	...
	public MenuExtremeCrafting(int id, Inventory inventory, TileExtremeCraftingTable tile) {
		...
		this.addSlot(this.resultSlot = new SlotExtremeResult(this.player, this.craftSlots, this.resultContainer, 0, 210,
				80));
	...
	public boolean stillValid(Player player) {
		...
		return this.tile.getLevel().getBlockState(pos).is(AvaritiaBlocks.EXTREME_CRAFTING_TABLE.get())
