...
public class AvaritiaJEIPlugin implements IModPlugin {
	...
	public void registerRecipes(IRecipeRegistration registration) {
		...
		registration.addRecipes(COLLECTOR, RecipeUtils.getCollectorRecipes(level));
	}
	
	@Override
	public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
		registration.addRecipeCatalyst(new ItemStack(AvaritiaBlocks.COMPRESSED_CRAFTING_TABLE.get()), RecipeTypes.CRAFTING);
		registration.addRecipeCatalyst(new ItemStack(AvaritiaBlocks.DOUBLE_COMPRESSED_CRAFTING_TABLE.get()), RecipeTypes.CRAFTING);
		registration.addRecipeCatalyst(new ItemStack(AvaritiaBlocks.EXTREME_CRAFTING_TABLE.get()), EXTREME_CRAFTING);
		registration.addRecipeCatalyst(new ItemStack(AvaritiaBlocks.COMPRESSOR.get()), COMPRESSOR);
		registration.addRecipeCatalyst(new ItemStack(AvaritiaBlocks.NEUTRON_COLLECTOR.get()), COLLECTOR);
	}
