...
public class AvaritiaRenderType extends RenderType {

	public AvaritiaRenderType(String name, VertexFormat vertexFormat, Mode mode, int bufferSize, boolean affectsCrumbling, boolean sortOnUpload, Runnable setupState, Runnable clearState) {
	...
	public static final RenderType COSMIC_RENDER_TYPE = RenderType.create(
			...
			RenderType.CompositeState.builder()
			        .setShaderState(new RenderStateShard.ShaderStateShard(AvaritiaCosmicShaders.cosmicShader))
	...
	public static final RenderType COSMIC_ARMOR_RENDER_TYPE = RenderType.create(
			...
			VertexFormat.Mode.QUADS, 2097152, true, false,
			RenderType.CompositeState.builder()
			        .setShaderState(new RenderStateShard.ShaderStateShard(AvaritiaCosmicShaders.cosmicArmorShader))
