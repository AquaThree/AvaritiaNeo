...
public class AvaritiaShaders {
	...
	public static void onRegisterShaders(RegisterShadersEvent event) throws IOException {
		event.registerShader(new ShaderInstance(event.getResourceProvider(),
				ResourceLocation.tryBuild(Avaritia.MODID, "cosmic"), DefaultVertexFormat.BLOCK), shader -> {
					cosmicShader = shader;
		...
		event.registerShader(new ShaderInstance(event.getResourceProvider(),
				ResourceLocation.tryBuild(Avaritia.MODID, "cosmic"), DefaultVertexFormat.NEW_ENTITY), shader -> {
